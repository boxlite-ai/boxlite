...
pub type CContainerCapabilities = info::CContainerCapabilities;
pub type CBoxAdvancedInfo = info::CBoxAdvancedInfo;
pub type CBoxInfoV2 = info::CBoxInfoV2;
pub type CBoxInfoListV2 = info::CBoxInfoListV2;
