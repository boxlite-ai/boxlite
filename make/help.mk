...
help:
	...
	@echo "    make test:integration:cli   - Run CLI integration tests (excludes privileged/dind, FILTER=<pattern>)"
	@echo "    make test:integration:privileged - Run privileged-kernel/dind tests (opt-in, ~80 s, needs libkrunfw-privileged)"
