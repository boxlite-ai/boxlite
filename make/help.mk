...
help:
	...
	@echo "    make guest          - Build guest agent + static tools (PROFILE=release|debug)"
	@echo "    make guest-tools    - Build only static mke2fs/resize2fs guest tools"
	...
	@echo "    make test:unit:guest        - Run guest unit tests"
	@echo "    make test:guest-tools       - Verify and smoke-test static guest tools"
