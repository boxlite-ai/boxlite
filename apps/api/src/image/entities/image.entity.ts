...
// stay env-driven and the catalog endpoint unions them in, so rotating one
...
// Covers both the per-org listing and the count the admission gate takes
// before every cold pull.
