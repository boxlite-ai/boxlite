...
import { AddBoxNetworkRateLimit1787100000000 } from '../../migrations/pre-deploy/1787100000000-add-box-network-rate-limit-migration'
...
describeIfDatabase('UsageService (integration, real Postgres + Redis)', () => {
  ...
  beforeAll(async () => {
    ...
    try {
      ...
      await new AddBoxNetworkRateLimit1787100000000().up(queryRunner)
      ownsTables = true
    } finally {
