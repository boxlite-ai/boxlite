...
import { AddBoxExitCode1787100000000 } from '../../migrations/pre-deploy/1787100000000-add-box-exit-code-migration'
...
describeIfDatabase('UsageService (integration, real Postgres + Redis)', () => {
  ...
  beforeAll(async () => {
    ...
    try {
      ...
      await new AddBoxExitCode1787100000000().up(queryRunner)
      ownsTables = true
    } finally {
