...
export class AddBoxUsagePeriods1785300000000 implements MigrationInterface {
  name = 'AddBoxUsagePeriods1785300000000'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_box_usage_periods_organization_start_end" ON "box_usage_periods" ("organizationId", "startAt", "endAt")`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_box_usage_periods_archive_organization_start_end" ON "box_usage_periods_archive" ("organizationId", "startAt", "endAt")`,
    )
    await queryRunner.query(
      `CREATE INDEX "idx_box_usage_periods_archive_box_start_end" ON "box_usage_periods_archive" ("boxId", "startAt", "endAt")`,
    )
  }
