...
export class Migration1782000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "organization_invitation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "organizationId" uuid NOT NULL, "email" character varying NOT NULL, "invitedBy" character varying NOT NULL DEFAULT '', "role" "public"."organization_invitation_role_enum" NOT NULL DEFAULT 'member', "expiresAt" TIMESTAMP WITH TIME ZONE NOT NULL, "status" "public"."organization_invitation_status_enum" NOT NULL DEFAULT 'pending', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "organization_invitation_id_pk" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(`
            ...
            VALUES
                (
                    ...
                    'Developer',
                    'Grants the ability to create boxes in the organization',
                    ARRAY['write:boxes']::organization_role_permissions_enum[],
                    TRUE
                ),
                (
                    '00000000-0000-0000-0000-000000000002',
                    'Boxes Admin',
                    'Grants admin access to boxes in the organization',
                    ARRAY['write:boxes', 'delete:boxes']::organization_role_permissions_enum[],
                    TRUE
                ),
                (
                    '00000000-0000-0000-0000-000000000003',
                    'Templates Admin',
                    'Grants admin access to templates in the organization',
                    ARRAY['write:templates', 'delete:templates']::organization_role_permissions_enum[],
                    TRUE
                ),
                (
                    ...
                    ARRAY['write:registries', 'delete:registries']::organization_role_permissions_enum[],
                    TRUE
                ),
                (
                ...
                (
                    ...
                    ARRAY['read:volumes', 'write:volumes', 'delete:volumes']::organization_role_permissions_enum[],
                    TRUE
                ),
                (
                    ...
                    ARRAY['read:audit_logs']::organization_role_permissions_enum[],
                    TRUE
                ),
                (
    ...
    await queryRunner.query(
      `CREATE INDEX "warm_pool_find_idx" ON "warm_pool" ("savedImage", "target", "class", "cpu", "mem", "disk", "gpu", "osUser", "env") `,
    )
    await queryRunner.query(
      `CREATE TABLE "box_last_activity" ("boxId" character varying NOT NULL, "lastActivityAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "box_last_activity_boxId_pk" PRIMARY KEY ("boxId"))`,
    )
    ...
    await queryRunner.query(
      `CREATE TABLE "ssh_access" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "boxId" character varying NOT NULL, "token" text NOT NULL, "expiresAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "ssh_access_id_pk" PRIMARY KEY ("id"))`,
    )
    ...
    await queryRunner.query(
      `ALTER TABLE "box_last_activity" ADD CONSTRAINT "box_last_activity_boxId_fk" FOREIGN KEY ("boxId") REFERENCES "box"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "ssh_access" ADD CONSTRAINT "ssh_access_boxId_fk" FOREIGN KEY ("boxId") REFERENCES "box"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "ssh_access" DROP CONSTRAINT "ssh_access_boxId_fk"`)
    await queryRunner.query(`ALTER TABLE "box_last_activity" DROP CONSTRAINT "box_last_activity_boxId_fk"`)
    await queryRunner.query(`ALTER TABLE "organization_user" DROP CONSTRAINT "organization_user_organizationId_fk"`)
    await queryRunner.query(`ALTER TABLE "organization_role" DROP CONSTRAINT "organization_role_organizationId_fk"`)
    await queryRunner.query(
