...
export class AddBoxLifecycleSeconds1784250000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `UPDATE "box" SET "autoStop" = CASE WHEN "autoStop" > 0 THEN "autoStop" * 60 ELSE 0 END, "autoDelete" = CASE WHEN "autoDelete" > 0 THEN "autoDelete" * 60 ELSE 0 END`,
    )
    await queryRunner.query(`ALTER TABLE "box" ALTER COLUMN "autoStop" SET DEFAULT 900`)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `UPDATE "box" SET "autoStop" = CASE WHEN "autoStop" > 0 THEN CEIL("autoStop" / 60.0)::integer ELSE 0 END, "autoDelete" = CASE WHEN "autoDelete" > 0 THEN CEIL("autoDelete" / 60.0)::integer ELSE -1 END`,
    )
    await queryRunner.query(`ALTER TABLE "box" ALTER COLUMN "autoStop" SET DEFAULT 15`)
    await queryRunner.query(`ALTER TABLE "box" ALTER COLUMN "autoDelete" SET DEFAULT -1`)
    await queryRunner.query(`ALTER TABLE "box" RENAME COLUMN "autoStop" TO "autoStopInterval"`)
