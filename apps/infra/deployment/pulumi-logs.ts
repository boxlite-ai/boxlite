 ...
 */
export async function removePulumiEventLogs(pulumiRoot: any) {
  let removedCount = 0

  async function visit(directory: any) {
    let entries
    try {
 ...
 */
export async function withPulumiEventLogCleanup(pulumiRoot: any, runSstCommand: any) {
