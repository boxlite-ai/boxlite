...
export const STORABLE_STAGE_CONFIG_KEYS: readonly string[] = [
  ...
  'BUSINESS_EVENTS_BATCH_SIZE',
  'BUSINESS_EVENTS_CONCURRENCY',
  'BUSINESS_EVENTS_ENABLED',
  'BUSINESS_EVENTS_INTERVAL_MS',
  'BUSINESS_EVENTS_MAX_ATTEMPTS',
  'BUSINESS_EVENTS_MAX_BACKOFF_MS',
  'BUSINESS_EVENTS_TIMEOUT_MS',
  'BUSINESS_EVENTS_VISIBILITY_MS',
