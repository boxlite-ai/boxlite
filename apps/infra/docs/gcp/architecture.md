...
The GCP control plane, proxy and runner fleet use separate managed services, with billable resources marked by dollar signs.

# GCP architecture

[Cloud guide](README.md) · [Infrastructure index](../../README.md)

These diagrams describe checked-in declarations, not a live project inventory.
...
Source: [GCP providers](../../mdeploy/stack/providers/gcp/), [bootstrap](../../bootstrap/gcp.ts).
