...
export const RUNNER_RESOURCE_TYPE = 'aws:ec2/instance:Instance'
export const RUNNER_RESOURCE_NAME_PATTERN = /^Runner(?:-runner-[1-9][0-9]*)?$/
export const RUNNER_RESOURCE_CANDIDATE_PATTERN = /^Runner(?:-|$)/
export const CONTROL_PLANE_NAME_TAG = 'boxlite:control-plane-runner-name'

export function hasRunnerIdentityTags(properties: any) {
...
export function isRunnerLikeResource({ name, type, properties }: any, expectedResourceNames = new Set()) {
...
function resolveRunnerCount(configuredCount: any) {
...
function requireValidRunnerName(name: any) {
...
export function resolveRunnerInventory(environment = process.env) {
