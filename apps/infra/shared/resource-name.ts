 ...
 * the ones that cannot call TypeScript: bootstrap/aws/github-deploy-role.yaml declares both,
 ...
 *
 * A fourth place is easy to miss and is not a spelling at all: bootstrap/aws/github-deploy-role.yaml's
