        ...
        "/v1/boxes/{boxId}/attach": {
            "get": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "already attached, or the box cannot be attached to",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
