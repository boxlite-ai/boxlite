...
type AdminAPI interface {
	...
	*/
	...
	/*
	AdminGetOrganizationQuota Get organization quota

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId
	@return AdminAPIAdminGetOrganizationQuotaRequest
	*/
	AdminGetOrganizationQuota(ctx context.Context, organizationId string) AdminAPIAdminGetOrganizationQuotaRequest

	// AdminGetOrganizationQuotaExecute executes the request
	//  @return AdminOrganizationQuota
	AdminGetOrganizationQuotaExecute(r AdminAPIAdminGetOrganizationQuotaRequest) (*AdminOrganizationQuota, *http.Response, error)
	...
	*/
	...
	/*
	AdminUpdateOrganizationQuota Update organization quota

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId
	@return AdminAPIAdminUpdateOrganizationQuotaRequest
	*/
	AdminUpdateOrganizationQuota(ctx context.Context, organizationId string) AdminAPIAdminUpdateOrganizationQuotaRequest

	// AdminUpdateOrganizationQuotaExecute executes the request
	//  @return AdminOrganizationQuota
	AdminUpdateOrganizationQuotaExecute(r AdminAPIAdminUpdateOrganizationQuotaRequest) (*AdminOrganizationQuota, *http.Response, error)
...
type AdminAPIAdminGetOrganizationQuotaRequest struct {
	ctx context.Context
	ApiService AdminAPI
	organizationId string
}

func (r AdminAPIAdminGetOrganizationQuotaRequest) Execute() (*AdminOrganizationQuota, *http.Response, error) {
	return r.ApiService.AdminGetOrganizationQuotaExecute(r)
}
...
AdminGetOrganizationQuota Get organization quota
 ...
 @return AdminAPIAdminGetOrganizationQuotaRequest
*/
func (a *AdminAPIService) AdminGetOrganizationQuota(ctx context.Context, organizationId string) AdminAPIAdminGetOrganizationQuotaRequest {
	return AdminAPIAdminGetOrganizationQuotaRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return AdminOrganizationQuota
func (a *AdminAPIService) AdminGetOrganizationQuotaExecute(r AdminAPIAdminGetOrganizationQuotaRequest) (*AdminOrganizationQuota, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AdminOrganizationQuota
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminAPIService.AdminGetOrganizationQuota")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/admin/organizations/{organizationId}/quota"
...
type AdminAPIAdminUpdateOrganizationQuotaRequest struct {
	ctx context.Context
	ApiService AdminAPI
	organizationId string
...
func (r AdminAPIAdminUpdateOrganizationQuotaRequest) AdminUpdateOrganizationQuota(adminUpdateOrganizationQuota AdminUpdateOrganizationQuota) AdminAPIAdminUpdateOrganizationQuotaRequest {
	r.adminUpdateOrganizationQuota = &adminUpdateOrganizationQuota
	return r
}

func (r AdminAPIAdminUpdateOrganizationQuotaRequest) Execute() (*AdminOrganizationQuota, *http.Response, error) {
	return r.ApiService.AdminUpdateOrganizationQuotaExecute(r)
}
...
AdminUpdateOrganizationQuota Update organization quota
 ...
 @return AdminAPIAdminUpdateOrganizationQuotaRequest
*/
func (a *AdminAPIService) AdminUpdateOrganizationQuota(ctx context.Context, organizationId string) AdminAPIAdminUpdateOrganizationQuotaRequest {
	return AdminAPIAdminUpdateOrganizationQuotaRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return AdminOrganizationQuota
func (a *AdminAPIService) AdminUpdateOrganizationQuotaExecute(r AdminAPIAdminUpdateOrganizationQuotaRequest) (*AdminOrganizationQuota, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminAPIService.AdminUpdateOrganizationQuota")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.adminUpdateOrganizationQuota == nil {
		return localVarReturnValue, nil, reportError("adminUpdateOrganizationQuota is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.adminUpdateOrganizationQuota
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
