...
type BoxAPI interface {
	...
	*/
	...
	/*
	ListSupportedBoxImages List supported box images

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return BoxAPIListSupportedBoxImagesRequest
	*/
	ListSupportedBoxImages(ctx context.Context) BoxAPIListSupportedBoxImagesRequest

	// ListSupportedBoxImagesExecute executes the request
	//  @return []SupportedBoxImage
	ListSupportedBoxImagesExecute(r BoxAPIListSupportedBoxImagesRequest) ([]SupportedBoxImage, *http.Response, error)
...
type BoxAPIListSupportedBoxImagesRequest struct {
	ctx context.Context
	ApiService BoxAPI
	xBoxLiteOrganizationID *string
}
...
// Use with JWT to specify the organization ID
func (r BoxAPIListSupportedBoxImagesRequest) XBoxLiteOrganizationID(xBoxLiteOrganizationID string) BoxAPIListSupportedBoxImagesRequest {
	r.xBoxLiteOrganizationID = &xBoxLiteOrganizationID
	return r
}

func (r BoxAPIListSupportedBoxImagesRequest) Execute() ([]SupportedBoxImage, *http.Response, error) {
	return r.ApiService.ListSupportedBoxImagesExecute(r)
}
...
ListSupportedBoxImages List supported box images
 ...
 @return BoxAPIListSupportedBoxImagesRequest
*/
func (a *BoxAPIService) ListSupportedBoxImages(ctx context.Context) BoxAPIListSupportedBoxImagesRequest {
	return BoxAPIListSupportedBoxImagesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []SupportedBoxImage
func (a *BoxAPIService) ListSupportedBoxImagesExecute(r BoxAPIListSupportedBoxImagesRequest) ([]SupportedBoxImage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []SupportedBoxImage
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BoxAPIService.ListSupportedBoxImages")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/box/supported-images"
