...
import { CompressedScreenshotResponse, RegionScreenshotResponse } from '@boxlite-labs/api-client'
import { ComputerUse, ScreenshotRegion } from '@boxlite-labs/sdk'
import { ScreenshotResponse } from '@boxlite-labs/toolbox-api-client'
