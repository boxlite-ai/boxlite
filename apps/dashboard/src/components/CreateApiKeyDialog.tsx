...
export const CreateApiKeyDialog: React.FC<CreateApiKeyDialogProps> = ({
  ...
  // Empty until the dialog opens, where the effect below seeds the selectable
  // groups. Seeding from availablePermissions here would carry the
  // always-granted box permissions, which submit prepends again.
  const [selectedPermissions, setSelectedPermissions] = useState<CreateApiKeyPermissionsEnum[]>([])
            ...
            <div className="flex justify-end gap-[10px] border-t border-border px-[26px] py-4">
              ...
              <button
                ...
                disabled={
                  ...
                  submitting ||
                  !organizationId ||
                  grantedByDefault.length + selectedPermissions.length === 0
                }
