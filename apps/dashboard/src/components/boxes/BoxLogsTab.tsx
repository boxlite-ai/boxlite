...
import { ChevronDown, ChevronLeft, ChevronRight, FileText, RefreshCw, Search } from '@/components/ui/icon'
  ...
  return (
    <Empty className="flex-1 border-0">
      <EmptyHeader>
        ...
        <EmptyDescription>Try adjusting your time range or filters.</EmptyDescription>
      </EmptyHeader>
    </Empty>
  )
}
