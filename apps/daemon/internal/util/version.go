...
// It looks for the X-BoxLite-SDK-Version~<version> subprotocol in the Sec-WebSocket-Protocol header.
...
func ExtractSdkVersionSubprotocol(header http.Header) string {
	...
	const prefix = "X-BoxLite-SDK-Version~"
