...
const apiSpecs = [
  ...
  'api/src/billing/access/billing-access.spec.ts',
  ...
  'api/src/box/common/redis-lock.provider.spec.ts',
  'api/src/box/services/billing-enforcement.service.spec.ts',
  ...
  'api/src/migrations/pre-deploy/1783910000000-migration.spec.ts',
]
...
const stages = {
  ...
  enforcement: jest('Billing access enforcement', [
    'api/src/billing/access/billing-access.spec.ts',
    'api/src/billing/access/billing-access.service.spec.ts',
    'api/src/billing/wallet.service.spec.ts',
    'api/src/box/common/redis-lock.provider.spec.ts',
  ...
  lint: {
    ...
    args: [
      ...
      'api/src/migrations/pre-deploy/1782700400000-migration.spec.ts',
      'api/src/migrations/pre-deploy/1783910000000-migration.ts',
      'api/src/migrations/pre-deploy/1783910000000-migration.spec.ts',
      'api/src/migrations/pre-deploy/1784707200000-migration.ts',
      'api/src/migrations/pre-deploy/1784707200000-migration.spec.ts',
      'api/src/box/common/redis-lock.provider.ts',
      'api/src/box/common/redis-lock.provider.spec.ts',
      'api/src/box/services/billing-enforcement.service.ts',
      'api/src/box/services/billing-enforcement.service.spec.ts',
      'api/src/box/services/box.service.ts',
      'api/src/box/services/box.service.spec.ts',
      'api/src/boxlite-rest/boxlite-proxy.controller.ts',
      'api/src/boxlite-rest/boxlite-proxy.controller.spec.ts',
      'api/src/box/box.module.ts',
      'api/src/box/entities/box.entity.ts',
      ...
      'scripts/billing-e2e-session.mjs',
      'scripts/billing-golden-e2e.mjs',
      'scripts/billing-golden-e2e.test.mjs',
...
const suites = {
  ...
  enforcement: {
    description: 'PR8 prepaid access admission and enforcement',
